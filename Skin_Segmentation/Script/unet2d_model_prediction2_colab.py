...
# path to image input
DATA_PATH ='/content/drive/MyDrive/pfe/Skin_Segmentation/Inputs/Nifti_images/CT_*.nii.gz'
...
new_model = tf.keras.models.load_model('/content/drive/MyDrive/pfe/Skin_Segmentation/Weights/model_for_medic.h5')
...
def predict_data(data_path):
  ...
  for count, file in enumerate(data,1):
    ...
    for i in resultat :
      ...
      nib.save(nft_img, os.path.join('/content/drive/MyDrive/pfe/Skin_Segmentation/Outputs/Nifti_Outputs/Output_img%01.0d.nii.gz'%count ))
      cv2.imwrite('/content/drive/MyDrive/pfe/Skin_Segmentation/Outputs/JPEG_Outputs/Output_img%01.0d.jpeg'%count, i)
      print("{} / {}".format(count,total))
